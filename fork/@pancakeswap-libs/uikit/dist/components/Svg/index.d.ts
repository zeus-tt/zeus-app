...
export { default as GraphCloseIcon } from "./Icons/GraphClose";
export { default as GraphOpenIcon } from "./Icons/GraphOpen";
...
export { default as MeatBallsMenuIcon } from "./Icons/MeatBallsMenu";
