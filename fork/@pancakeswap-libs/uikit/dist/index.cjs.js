...
var styleVariants$2 =
  ...
  (_b$2[variants$3.SUBTLE] = {
    backgroundColor: 'transparent',
    border: '0px',
    boxShadow: '0px -2px 0px #1794BB inset',
    color: 'primary',
  }),
...
var Icon$1gOpen = function (props) {
  // graph show icon
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 24 24' }, props),
    React.createElement('path', {
      d: 'M2.625 10.5H6.125V18.375H2.625V10.5ZM14.875 7H18.375V18.375H14.875V7ZM8.75 1.75H12.25V18.375H8.75V1.75Z',
    })
  )
}

var Icon$1gClose = function (props) {
  // graph show icon
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 24 24' }, props),
    ...
    React.createElement('rect', {
      ...
      width: '22.415',
      height: '1.93303',
      transform: 'rotate(-38.224 1.4213 17.2903)',
      stroke: '#000000',
      strokeWidth: '0.6',
    })
  )
...
var Icon$1globe = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 32 32' }, props),
    React.createElement('path', {
      d:
        'M16 29.3334C8.63596 29.3334 2.66663 23.3641 2.66663 16.0001C2.66663 8.63608 8.63596 2.66675 16 2.66675C23.364 2.66675 29.3333 8.63608 29.3333 16.0001C29.3333 23.3641 23.364 29.3334 16 29.3334ZM24.4733 21.2694V21.1294C24.4733 19.9001 24.4733 19.3387 23.604 18.8414C23.3245 18.683 23.0375 18.5384 22.744 18.4081C22.2546 18.1854 21.9306 18.0401 21.4933 17.4001C21.4411 17.3241 21.3895 17.2476 21.3386 17.1707C20.8786 16.4707 20.5466 15.9667 19.2826 16.1667C16.796 16.5614 16.612 16.9987 16.5026 17.7374L16.4853 17.8587C16.324 18.9387 16.2946 19.3014 16.7453 19.7747C18.432 21.5441 19.4426 22.8201 19.7493 23.5667C19.8986 23.9307 20.2826 25.0334 20.0186 26.1241C21.6371 25.4794 23.0777 24.4567 24.22 23.1414C24.3666 22.6427 24.4733 22.0214 24.4733 21.2694ZM16 5.11075C12.9106 5.11075 10.12 6.39875 8.13863 8.46542C8.37463 8.62942 8.57996 8.86008 8.72129 9.17741C8.99329 9.78675 8.99329 10.4147 8.99329 10.9707C8.99329 11.4081 8.99329 11.8241 9.13329 12.1241C9.32529 12.5347 10.1546 12.7107 10.8866 12.8627C11.1493 12.9187 11.4186 12.9747 11.664 13.0427C12.3386 13.2294 12.8613 13.8361 13.2786 14.3227C13.452 14.5241 13.7093 14.8214 13.8386 14.8961C13.9053 14.8481 14.12 14.6147 14.2253 14.2321C14.308 13.9387 14.284 13.6801 14.1653 13.5387C13.4186 12.6587 13.46 10.9654 13.6906 10.3401C14.0533 9.35475 15.1866 9.42808 16.016 9.48141C16.3253 9.50141 16.616 9.52141 16.8346 9.49341C17.664 9.38941 17.92 8.12675 18.1 7.88008C18.4893 7.34675 19.6813 6.54275 20.42 6.04675C19.0286 5.42807 17.5226 5.10916 16 5.11075Z',
    })
  )
}

var Icon$1meatballMenu = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0 32 32' }, props),
    React.createElement('path', {
      d:
        'M6.66667 13.3333C5.2 13.3333 4 14.5333 4 15.9999C4 17.4666 5.2 18.6666 6.66667 18.6666C8.13333 18.6666 9.33333 17.4666 9.33333 15.9999C9.33333 14.5333 8.13333 13.3333 6.66667 13.3333ZM25.3333 13.3333C23.8667 13.3333 22.6667 14.5333 22.6667 15.9999C22.6667 17.4666 23.8667 18.6666 25.3333 18.6666C26.8 18.6666 28 17.4666 28 15.9999C28 14.5333 26.8 13.3333 25.3333 13.3333ZM16 13.3333C14.5333 13.3333 13.3333 14.5333 13.3333 15.9999C13.3333 17.4666 14.5333 18.6666 16 18.6666C17.4667 18.6666 18.6667 17.4666 18.6667 15.9999C18.6667 14.5333 17.4667 13.3333 16 13.3333Z',
    })
  )
}
...
var Icon$10 = function (props) {
  return React.createElement(
    Svg,
    __assign({ viewBox: '0 0
76.8197 8.18187 78.2572 8.01164 79.865 8.01164C81.5105 8.01164 82.9291 8.14404 84.1208 8.40885C85.3313 8.67365 86.3338 8.96683 87.1282 9.28838C88.055 9.68559 88.8495 10.1206 89.5115 10.5935L86.8729 15.4168C86.3622 15.133 85.7853 14.8777 85.1422 14.6507C84.4991 14.4048 83.8371 14.2062 83.1561 14.0549C82.4752 13.8847 81.8037 13.7523 81.1417 13.6577C80.4986 13.5631 79.9028 13.5158 79.3543 13.5158C78.4653 13.5158 77.756 13.6199 77.2264 13.8279C76.6967 14.036 76.4319 14.3292 76.4319 14.7074C76.4319 14.9912 76.6305 15.2371 77.0278 15.4451C77.425 15.6343 77.9451 15.8234 78.5882 16.0126C79.2313 16.2017 79.969 16.3909 80.8012 16.58C81.6335 16.7692 82.4752 17.0056 83.3264 17.2893C84.1964 17.5541 85.0476 17.8757 85.8798 18.254C86.7121 18.6323 87.4498 19.0957 88.0929 19.6442C88.736 20.1927 89.2561 20.8453 89.6533 21.6019C90.0505 22.3395 90.2491 23.2191 90.2491 24.2405C90.2491 25.016 90.06 25.7915 89.6817 26.567C89.3034 27.3425 88.7171 28.0423 87.9226 28.6665C87.1282 29.2907 86.1068 29.7919 84.8584 30.1702C83.629 30.5674 82.1536 30.766 80.4324 30.766C78.749 30.766 77.2074 30.6336 75.8078 30.3688C74.427 30.1229 73.2259 29.8392 72.2045 29.5177C71.0129 29.1583 69.9347 28.7422 68.9701 28.2693L71.098 22.6233Z',
      fill: 'url(#paint1_radial_8_162)',
    }),
    React.createElement(
      'defs',
      null,
      React.createElement(
        'radialGradient',
        {
          id: 'paint0_radial_8_162',
          cx: '0',
          cy: '0',
          r: '1',
          gradientUnits: 'userSpaceOnUse',
          gradientTransform: 'translate(47.5024 39.8597) rotate(10.4768) scale(36.1647 15.495)',
        },
        React.createElement('stop', { stopColor: '#00357C' }),
        React.createElement('stop', { offset: '0.489583', stopColor: '#48D1ED' }),
        React.createElement('stop', { offset: '1', stopColor: '#C9F9FD' })
      ),

      React.createElement(
        'radialGradient',
        {
          id: 'paint1_radial_8_162',
          cx: '0',
          cy: '0',
          r: '1',
          gradientUnits: 'userSpaceOnUse',
          gradientTransform: 'translate(47.7395 21.8613) rotate(21.0375) scale(39.3857 31.6208)',
        },
        React.createElement('stop', { stopColor: '#3FADED' }),
        React.createElement('stop', { offset: '0.489583', stopColor: '#48D1ED' }),
        React.createElement('stop', { offset: '1', stopColor: '#C9F9FD' })
      )
    )
...
var BalanceInput = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement(
      StyledInput$1,
      __assign({ type: 'number', value: value, onChange: onChange, placeholder: placeholder }, inputProps)
    ),
    currencyValue &&
...
var ButtonMenuItem = function (_a) {
  ...
  if (!isActive) {
    return React.createElement(InactiveButton, __assign({ forwardedAs: as, variant: '' }, props))
  }
...
var Overlay = styled.div.attrs({ role: 'presentation' })(
  templateObject_1$g ||
    (templateObject_1$g = __makeTemplateObject(
      [
        '\n  position: fixed;\n  top: 0px;\n  left: 0px;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(2, 23, 41, 0.2);\n  transition: opacity 0.4s;\n  opacity: ',
        ';\n  z-index: ',
        ';\n  pointer-events: ',
        ';\n',
      ],
...
var Logo$2 = function (_a) {
  ...
  return React.createElement(
    ...
    React.createElement('path', {
      d:
        'M23.4815 17.4967C23.4815 21.2907 18.4486 24.3663 12.2402 24.3663C6.03189 24.3663 0.999023 21.2907 0.999023 17.4967V15.748H23.4815V17.4967Z',
      fill: '#FEDC90',
    }),
    React.createElement('path', {
      fillRule: 'evenodd',
      clipRule: 'evenodd',
      d:
        'M5.37202 4.31671C5.1116 2.92216 6.18164 1.63379 7.6003 1.63379C8.85222 1.63379 9.8671 2.64867 9.8671 3.90059V9.0315C10.6321 8.93102 11.4261 8.87813 12.2402 8.87813C13.0356 8.87813 13.8116 8.9286 14.5602 9.02459V3.90059C14.5602 2.64867 15.5751 1.63379 16.827 1.63379C18.2457 1.63379 19.3157 2.92216 19.0553 4.31671L18.021 9.85488C21.2925 11.056 23.4815 13.2457 23.4815 15.7478C23.4815 19.5418 18.4486 22.6174 12.2402 22.6174C6.03189 22.6174 0.999023 19.5418 0.999023 15.7478C0.999023 13.2584 3.16579 11.0782 6.40968 9.87326L5.37202 4.31671Z',
      fill: '#D1884F',
    }),
    React.createElement('path', {
      className: 'left-eye',
      d:
        'M9.11817 15.2485C9.11817 16.2833 8.55896 17.1221 7.86914 17.1221C7.17932 17.1221 6.62012 16.2833 6.62012 15.2485C6.62012 14.2138 7.17932 13.375 7.86914 13.375C8.55896 13.375 9.11817 14.2138 9.11817 15.2485Z',
      fill: '#633001',
    }),
    React.createElement('path', {
      className: 'right-eye',
      d:
        'M17.7363 15.2485C17.7363 16.2833 17.1771 17.1221 16.4873 17.1221C15.7975 17.1221 15.2383 16.2833 15.2383 15.2485C15.2383 14.2138 15.7975 13.375 16.4873 13.375C17.1771 13.375 17.7363 14.2138 17.7363 15.2485Z',
      fill: '#633001',
    })
  )
}
...
var Logo = function (_a) {
  ...
  var innerLogo = React.createElement(React.Fragment, null, React.createElement(Icon$10, { className: 'desktop-icon' }))
  return React.createElement(
    Flex,
    null,
    React.createElement(
    ...
    isAbsoluteUrl
      ? React.createElement(StyledLink, { as: 'a', href: href, 'aria-label': 'Zeus Exchange Home Page' }, innerLogo)
      : React.createElement(StyledLink, { to: href, 'aria-label': 'Zeus Exchange Home Page' }, innerLogo)
  )
}
...
var socials = [
  ...
  //     label: "Discord",
  //     icon: "DiscordIcon",
  //     href: "https://discord.gg/TEwDyb7d",
  //     items: [
  //         {
  //             label: "English",
  //             href: "https://discord.gg/TEwDyb7d",
  ...
  // },
  {
    label: 'Twitter',
    icon: 'TwitterIcon',
    href: 'https://twitter.com/ZeusExchange',
  },
]
var MENU_HEIGHT = 64
...
var WalletCard = function (_a) {
  ...
  return React.createElement(
    ...
    Icon
      ...
      : React.createElement('img', { src: Image, alt: 'tt wallet', height: '32px', width: '32px' })
  )
}
...
var Menu = function (_a) {
  ...
  // profile && React.createElement(Avatar, { profile: profile }) (avatar)
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), {
  ...
  gradients: {
    ...
    primaryGradient: 'linear-gradient(116.19deg, #2C6AB8 15.05%, #0E89D0 40.66%, #48D1ED 79.41%, #C9F9FD 99.14%)',
  },
})
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), {
  ...
  secondary: '#FFFFFF',
  background: '#00101F',
  backgroundDisabled: '#021729',
  backgroundAlt: '#021729',
  contrast: '#FFFFFF',
  dropdown: '#1E1D20',
  invertedContrast: '#051F36',
  input: '#051F36',
  inputSecondary: 'black',
  primaryDark: '#0098A1',
...
exports.Alert = Alert
exports.MeatBallsMenuIcon = Icon$1meatballMenu
exports.GlobeIcon = Icon$1globe
exports.GraphCloseIcon = Icon$1gClose
exports.GraphOpenIcon = Icon$1gOpen
